  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>Embark on a transformative educational journey with our university&#39;s comprehensive education programs. Our cutting-edge curriculum is designed to empower students with the knowledgem, skills, and experiences needed to excel in the dynamic field of education</p>
