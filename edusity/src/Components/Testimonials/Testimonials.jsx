            ...
            <ul ref={slider}>
                <li>
                    <div className="slide">
                        ...
                        <p>Choosing to pursue my degree at Edusity was one of the best decisions I&#39;ve ever made. The supportive community, state-f-the-art facilities, and commitment to academic excellence have truly exceeded my expectations.</p>
                    </div>
                </li>
                <li>
                    <div className="slide">
